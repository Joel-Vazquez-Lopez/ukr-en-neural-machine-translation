...
#SBATCH --gpus=l40s:1
#SBATCH -t 20:00:00
#SBATCH -J bpe_uk_en_30k_40ep_gpu
#SBATCH --output=logs/bpe_uk_en_30k_40ep_%j.out
#SBATCH --error=logs/bpe_uk_en_30k_40ep_%j.err
...
# Keep only checkpoint_best.pt and checkpoint_last.pt.
