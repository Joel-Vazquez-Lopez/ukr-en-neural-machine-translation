...
#SBATCH -M pelle
#SBATCH -t 35:00:00
#SBATCH -J bpe_nmt_uk_en_10000
#SBATCH -o results/bpe10000_train_%j.out
#SBATCH -e results/bpe10000_train_%j.err
...
DATA_DIR=$PROJECT/data/data-bin-bpe10000
WORK_DIR=$PROJECT/results/bpe10000
TRAIN_DIR=$WORK_DIR/checkpoints-bpe
TEXT=$PROJECT/data/bpe10000/bpe-data
