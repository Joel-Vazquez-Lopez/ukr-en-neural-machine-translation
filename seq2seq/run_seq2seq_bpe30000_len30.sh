...
#SBATCH -M pelle
#SBATCH -t 35:00:00
#SBATCH -J seq2seq_len30
#SBATCH -o results/seq2seq_bpe30000_len30_train_%j.out
#SBATCH -e results/seq2seq_bpe30000_len30_train_%j.err
...
mkdir -p results/seq2seq_bpe30000_len30/checkpoints
...
python seq2seq/seq2seq_train.py \
  ...
  --checkpoint_dir results/seq2seq_bpe30000_len30/checkpoints \
  --hidden_size 256 \
  --n_iters 100000 \
  --print_every 10000 \
  --status_every 1000 \
